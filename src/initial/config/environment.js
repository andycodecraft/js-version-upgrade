...
module.exports = function (environment) {
    var ENV = {
        ...
        APP: {
            ...
            prompt_to_save_after_seconds: 40,
            prompt_to_save_after_seconds_touch: 20,
            design_api_debug_parameters: true,
            minimum_shipping_cost: 140,
    ...
    if (environment === 'test' || environment === 'development') {
        ...
        ENV.APP.threeds_action = 'ACSDIRECT';
        ENV.APP.threeds_password = 'NeTb3714';
        ENV.APP.threeds_passwords = {
            USD: 'shGI2373',
            EUR: 'shGI2371',
            AUD: 'shGI2373',
            GBP: 'shGI2372',
    ...
    if (environment === 'production') {
        ...
        ENV.zendesk_config_unused = {
            key: null,
            initialized: false
        }

        ENV.zopim_config_unused = {
