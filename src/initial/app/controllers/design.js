...
export default Ember.Controller.extend({
    ...
    init: function () {
        ...
        var promptToSaveTimeoutSeconds = Modernizr.touch ? config.APP.prompt_to_save_after_seconds_touch : config.APP.prompt_to_save_after_seconds;

        Ember.run.later(this, function () {
            this.promptToSave();
        }, promptToSaveTimeoutSeconds * 1000);
    ...
    promptToSave: function () {
        ...
        var $modalLength = $('.modal:not("#error-modal"):visible').length;
