...
export default Ember.Controller.extend({
    ...
    threeDSPassword:    function () {
        const currency = `${this.get('controllers.design.currency.iso_code')}`.toUpperCase();

        if(currency && config.APP.threeds_passwords && currency in config.APP.threeds_passwords)
            return config.APP.threeds_passwords[currency];
